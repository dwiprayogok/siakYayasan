...
<section class="bg-gray-200 dark:bg-gray-200 sm:p-20">
    ...
    <h1 class="text-3xl py-4 border-b mb-10">List Nilai Siswa</h1>
        <div class="bg-black dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="apple-iphone-14-dropdown" class="hidden z-10 w-44 bg-black rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="apple-ipad-air-dropdown" class="hidden z-10 w-44 bg-black rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="xbox-series-s-dropdown" class="hidden z-10 w-44 bg-black rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="playstation-5-dropdown" class="hidden z-10 w-44 bg-black rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="xbox-series-x-dropdown" class="hidden z-10 w-44 bg-black rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
