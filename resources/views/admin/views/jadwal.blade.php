        ...
        <nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-200 dark:border-gray-200" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        ...
                        <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-700 md:ms-2 dark:text-black dark:hover:text-green-700">Jadwal Pelajaran</a>
                        </div>
                    </li>
    ...
    <div class="bg-white dark:bg-white relative shadow-md sm:rounded-lg overflow-hidden">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <div class="flex space-x-4">
                ...
                <button type="button" class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 
                focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-700 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800" 
                onclick="window.open('{{ route('jadwalpelajarans.print') }}?kelas={{ request('kelas') }}&hari={{ request('hari') }}', '_blank')">
                    <svg class="h-3.5 w-3.5 mr-2" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <tr class="border-b dark:border-gray-700">
                        ...
                        <td class="p-4">
                            ...
                            <button class="mr-2 detail" title="view" id="detail" data-id="{{ $japel->id }}" data-modal-target="detailModal" data-modal-toggle="detailModal">
                              ...
                              <button class="mr-2 detail" title="view" id="detail" onclick="window.open('{{ route('jadwalpelajarans.printDetail', ['id' => $japel->id]) }}', '_blank')" >
