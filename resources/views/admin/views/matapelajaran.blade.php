        ...
        <nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-200 dark:border-gray-200" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        ...
                        <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-green-700 md:ms-2 dark:text-black dark:hover:text-green-700">Mata Pelajaran</a>
                        </div>
                    </li>
                    ...
                    <tr class="border-b dark:border-gray-700">
                        ...
                        <td class="p-4">
                            ...
                            <button class="mr-2 detail" title="view" id="detail" data-id="{{ $mapel->id }}" data-modal-target="detailModal" data-modal-toggle="detailModal">
                              ...
                              <button class="mr-2 detail" title="view" id="detail" onclick="window.open('{{ route('matapelajarans.printDetail', ['id' => $mapel->id]) }}', '_blank')" >
