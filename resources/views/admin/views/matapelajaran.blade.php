...
<script>
    function printData() {
        // Example: Trigger browser's print dialog
        window.print();

        // Alternatively, you can navigate to a specific print route in Laravel
        // window.location.href = "{{ url('/adminControl/matapelajaran/print') }}";
    }
</script>
