                ...
                <table class="w-full text-sm text-left text-black dark:text-black" id="user-table">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="p-4">
                                <button class="mr-4 update" title="update" id="btnUpdate" data-id="{{ $siswa->id_student }}" data-modal-target="updateModal" data-modal-toggle="updateModal"  > 
                                ...
                                <button class="mr-4 btnDelete" title="delete" id="btnDelete" data-id="{{ $siswa->id }}" data-modal-target="deleteModal" data-modal-toggle="deleteModal">
                                ...
                                <button class="mr-2 detail" title="view" id="detail" data-id="{{ $siswa->id }}" data-modal-target="detailModal" data-modal-toggle="detailModal">
