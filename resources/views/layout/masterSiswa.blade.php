    ...
    >
                <nav class="bg-gray-400 border-black dark:bg-green-700">
                    <div class="flex flex-wrap items-center justify-between mx-auto p-4">
                        ...
                        <li>
                        <a href="\siswa\dashboard" class="block py-2 px-3 text-gray-900 text-lg  hover:bg-gray-200 md:hover:bg-transparent md:hover:text-green-700 md:p-0 dark:text-black md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Home</a>
                        </li>
                        <li>
                        <a href="\siswa\profilesiswa" class="block py-2 px-3 text-gray-900 text-lg  hover:bg-gray-200 md:hover:bg-transparent md:hover:text-green-700 md:p-0 dark:text-black md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Profile</a>
                        </li>
                        <li>
                        <a href="\siswa\infoGuru" class="block py-2 px-3 text-gray-900  text-lg hover:bg-gray-200 md:hover:bg-transparent md:hover:text-green-700 md:p-0 dark:text-black md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Data Guru</a>
                        </li>
                        <li>
                        <a href="\siswa\jadwalpelajaransiswa" class="block py-2 px-3 text-gray-900 text-lg hover:bg-gray-200 md:hover:bg-transparent md:hover:text-green-700 md:p-0 dark:text-black md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Jadwal Pelajaran</a>
                        </li>
                        <li>
                        <a href="\siswa\listteman" class="block py-2 px-3 text-gray-900 text-lg hover:bg-gray-200 md:hover:bg-transparent md:hover:text-green-700 md:p-0 dark:text-black md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">List Teman</a>
                        </li>
                        <li>
                        <a href="\siswa\listNilai" class="block py-2 px-3 text-gray-900 text-lg hover:bg-gray-200 md:hover:bg-transparent md:hover:text-green-700 md:p-0 dark:text-black md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Data Nilai</a>
                        </li>
                        </ul>
                        </div>
                    </div>
