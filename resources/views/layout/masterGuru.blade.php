...
<body class="flex flex-col min-h-screen">
      ...
      <nav class="bg-gray-400 border-gray-200 dark:bg-green-700">
            <div class="flex flex-wrap items-center justify-between mx-auto p-4">
                  ...
                  <li>
                  <a href="\guru\profileguru" class="block py-2 px-3 text-gray-900 text-lg  hover:bg-gray-200 md:hover:bg-transparent md:hover:text-green-700 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Profile</a>
                  </li>
                  <li>
                  <a href="\guru\inputnilai" class="block py-2 px-3 text-gray-900 text-lg  hover:bg-gray-200 md:hover:bg-transparent md:hover:text-green-700 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Input Nilai</a>
                  </li>
                  <li>
                  <a href="\guru\jadwalajar" class="block py-2 px-3 text-gray-900 text-lg  hover:bg-gray-200 md:hover:bg-transparent md:hover:text-green-700 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Jadwal Ajar</a>
                  </li>
                  </ul>
                  </div>
            </div>
